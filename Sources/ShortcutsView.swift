    ...
    private var categories: [Category] {
        [
            ...
            Category(title: .scCategoryPanel, rows: [
                ...
                Row(keys: "⇧⌘D", desc: .scToggleSecondTree),
                Row(keys: "⌃U", desc: .menuSwapTrees),
                Row(keys: "⌥⌘→", desc: .menuSameLocationRight),
                Row(keys: "⌥⌘←", desc: .menuSameLocationLeft),
            ]),
            Category(title: .scCategoryFKeys, rows: [
                Row(keys: "F3", desc: .fkeyView),
                Row(keys: "F4", desc: .fkeyEdit),
                Row(keys: "F5", desc: .scF5),
                Row(keys: "F6", desc: .scF6),
